...
var To = { 7: function(o, t, e) {
        ...
        var ie = c(r.useState(M.lang), 2), ge = ie[0], ae = ie[1], be = c(r.useState(p), 2), H = be[0], F = be[1], me = c(r.useState(!1), 2), Pe = me[0], Oe = me[1], Ee = function(re) {
          if (!H.hasOwnProperty(re)) {
            ...
            fetch(se).then(function(ue) {
              ...
              console.log("Aww, snap.", ue), F(l({}, p)), Oe(!0);
            });
          }
        };
      ...
      for (var r = [], l = 0; l < arguments.length; l++) {
        ...
        if (c) {
          ...
          if (u === "string" || u === "number") r.push(c);
            ...
            for (var d in c) n.call(c, d) && c[d] && r.push(d);
          }
        }
      }
      return r.join(" ");
  ...
  o.exports = function(t) {
    ...
    return e.toString = function() {
      ...
      for (var p = 0; p < n.length; p++) {
        var g = [].concat(n[p]);
        r && u[g[0]] || (c !== void 0 && (g[5] === void 0 || (g[1] = "@layer".concat(g[5].length > 0 ? " ".concat(g[5]) : "", " {").concat(g[1], "}")), g[5] = c), a && (g[2] && (g[1] = "@media ".concat(g[2], " {").concat(g[1], "}")), g[2] = a), l && (g[4] ? (g[1] = "@supports (".concat(g[4], ") {").concat(g[1], "}"), g[4] = l) : g[4] = "".concat(l)), e.push(g));
      }
    }, e;
  };
}, 645: (o) => {
  ...
  e.r(t), e.d(t, { Component: () => U, Fragment: () => M, cloneElement: () => Ue, createContext: () => He, createElement: () => x, createRef: () => D, h: () => x, hydrate: () => Me, isValidElement: () => l, options: () => a, render: () => he, toChildArray: () => me });
  var n, a, r, l, c, u, s, d, p, g = {}, f = [], C = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
  function A(m, v) {
  ...
  function be() {
    var m, v, y, E, N, P, q, G;
    for (c.sort(d); m = c.shift(); ) m.__d && (v = c.length, E = void 0, N = void 0, q = (P = (y = m).__v).__e, (G = y.__P) && (E = [], (N = A({}, P)).__v = P.__v + 1, Ae(G, P, N, y.__n, G.ownerSVGElement !== void 0, P.__h != null ? [q] : null, E, q ?? ie(P), P.__h), k(E, P), P.__e != q && ge(P)), c.length > v && c.sort(d));
    be.__r = 0;
  }
  ...
  }, U.prototype.render = M, c = [], s = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, d = function(m, v) {
  ...
  var n, a, r, l, c = e(616), u = 0, s = [], d = [], p = c.options.__b, g = c.options.__r, f = c.options.diffed, C = c.options.__c, A = c.options.unmount;
  function S(k, h) {
  ...
  c.options.__b = function(k) {
    ...
    f && f(k);
    var h = k.__c;
    h && h.__H && (h.__H.__h.length && (s.push(h) !== 1 && l === c.options.requestAnimationFrame || ((l = c.options.requestAnimationFrame) || Ee)(Pe)), h.__H.__.forEach(function(b) {
  ...
  var t = [];
  function e(r) {
    for (var l = -1, c = 0; c < t.length; c++) if (t[c].identifier === r) {
      l = c;
      break;
    }
    return l;
  ...
  function n(r, l) {
    for (var c = {}, u = [], s = 0; s < r.length; s++) {
      var d = r[s], p = l.base ? d[0] + l.base : d[0], g = c[p] || 0, f = "".concat(p, " ").concat(g);
      c[p] = g + 1;
      var C = e(f), A = { css: d[1], media: d[2], sourceMap: d[3], supports: d[4], layer: d[5] };
      if (C !== -1) t[C].references++, t[C].updater(A);
      else {
        var S = a(A, l);
        l.byIndex = s, t.splice(s, 0, { identifier: f, updater: S, references: 1 });
      }
      u.push(f);
    }
    return u;
  ...
  o.exports = function(r, l) {
    ...
    return function(u) {
      ...
      for (var p = n(u, l), g = 0; g < c.length; g++) {
        var f = e(c[g]);
  ...
  var t, e = (t = [], function(r, l) {
    return t[r] = l, t.filter(Boolean).join(`
`);
  });
  function n(r, l, c, u) {
    var s;
    ...
    if (r.styleSheet) r.styleSheet.cssText = e(l, s);
    else {
      var p = document.createTextNode(s), g = r.childNodes;
      g[l] && r.removeChild(g[l]), g.length ? r.insertBefore(p, g[l]) : r.appendChild(p);
    }
  }
  ...
  o.exports = function(r) {
    ...
    var l = a.singletonCounter++, c = a.singleton || (a.singleton = r.insertStyleElement(r));
...
function i(o, t, e, n, a, r) {
  var l, c, u = {};
  for (c in t) c == "ref" ? l = t[c] : u[c] = t[c];
  var s = { type: o, props: u, key: e, ref: l, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: --No, __source: a, __self: r };
  if (typeof o == "function" && (l = o.defaultProps)) for (c in l) u[c] === void 0 && (u[c] = l[c]);
...
function Uo(o) {
  ...
  var t = o.children, e = function(n, a) {
    if (n == null) return {};
    var r, l, c = {}, u = Object.keys(n);
    for (l = 0; l < u.length; l++) a.indexOf(r = u[l]) >= 0 || (c[r] = n[r]);
    return c;
  }(o, Mo);
...
O.options.unmount = function(o) {
  ...
  n.__u++ || u || n.setState({ __a: n.__b = n.__v.__k[0] }), o.then(l, l);
  ...
  if (typeof t == "string") {
    for (var a in n = {}, e) {
      ...
      if (!(a === "value" && "defaultValue" in e && r == null || Vo && a === "children" && t === "noscript")) {
        var l = a.toLowerCase();
        a === "defaultValue" && "value" in e && e.value == null ? a = "value" : a === "download" && r === !0 ? r = "" : l === "ondoubleclick" ? a = "ondblclick" : l !== "onchange" || t !== "input" && t !== "textarea" || Zo(e.type) ? l === "onfocus" ? a = "onfocusin" : l === "onblur" ? a = "onfocusout" : Ko.test(a) ? a = l : t.indexOf("-") === -1 && $o.test(a) ? a = a.replace(Bo, "-$&").toLowerCase() : r === null && (r = void 0) : l = a = "oninput", l === "oninput" && n[a = l] && (a = "oninputCapture"), n[a] = r;
      }
    }
...
var rn = function o(t, e) {
  function n(a, r, l) {
    if (typeof document < "u") {
      typeof (l = Ct({}, e, l)).expires == "number" && (l.expires = new Date(Date.now() + 864e5 * l.expires)), l.expires && (l.expires = l.expires.toUTCString()), a = encodeURIComponent(a).replace(/%(2[346B]|5E|60|7C)/g, decodeURIComponent).replace(/[()]/g, escape);
      var c = "";
      for (var u in l) l[u] && (c += "; " + u, l[u] !== !0 && (c += "=" + l[u].split(";")[0]));
...
class si {
  ...
  _fetch(t, e, n = new XMLHttpRequest()) {
    const a = this, r = this.api + t, l = this.timeout, c = this.getAuthToken(), u = this.lang;
    return new Promise(function(s, d) {
      n.open(e.method, r, !0), n.setRequestHeader("Accept", "application/json"), n.setRequestHeader("Content-Type", "application/json"), n.setRequestHeader("X-Language", u), c && n.setRequestHeader("Authorization", `Bearer ${c}`), n.timeout = l, n.withCredentials = !0, n.onload = () => {
...
`).forEach((r) => {
      ...
      l.startsWith("x-auth-token") ? e = t.getResponseHeader("X-Auth-Token") : l.startsWith("x-session-lifetime") ? n = parseInt(t.getResponseHeader("X-Session-Lifetime"), 10) : l.startsWith("x-session-retention") && (a = t.getResponseHeader("X-Session-Retention"));
    }), e) {
      const r = new RegExp("^https://"), l = !!this.api.match(r) && !!window.location.href.match(r), c = a === "session" ? void 0 : new Date((/* @__PURE__ */ new Date()).getTime() + 1e3 * n);
      this.setAuthToken(e, { secure: l, expires: c });
    }
  }
  get(t) {
...
class li {
  static throttle(t, e, n = {}) {
    ...
    let l, c, u, s = 0;
    const d = () => {
      s = a === !1 ? 0 : Date.now(), u = null, t.apply(l, c);
    };
    return function(...p) {
      const g = Date.now();
      s || a !== !1 || (s = g);
      const f = e - (g - s);
      l = this, c = p, f <= 0 || f > e ? (u && (window.clearTimeout(u), u = null), s = g, t.apply(l, c)) : u || r === !1 || (u = window.setTimeout(d, f));
    };
  }
}
class Gt {
...
class pi {
  constructor(t = "hanko_session", e, n, a) {
    this.channel = void 0, this.onSessionExpired = void 0, this.onSessionCreated = void 0, this.onLeadershipRequested = void 0, this.handleMessage = (r) => {
      ...
      switch (l.action) {
        case "sessionExpired":
          this.onSessionExpired(l);
          break;
        case "sessionCreated":
          this.onSessionCreated(l);
          break;
        case "requestLeadership":
          this.onLeadershipRequested(l);
      }
...
class ln {
  ...
  constructor({ name: t, payload: e, error: n, status: a, actions: r, csrf_token: l }, c) {
    Object.defineProperty(this, sn, { value: mi }), this.name = void 0, this.payload = void 0, this.error = void 0, this.status = void 0, this.csrf_token = void 0, Object.defineProperty(this, ot, { writable: !0, value: void 0 }), this.actions = void 0, this.fetchNextState = void 0, this.name = t, this.payload = e, this.error = n, this.status = a, this.csrf_token = l, an(this, ot)[ot] = r, this.actions = an(this, sn)[sn](r, l), this.fetchNextState = c;
  }
  runAction(t, e) {
    const n = {};
  ...
  validateAction(t) {
    if ("inputs" in t) for (const e in t.inputs) {
      let a = function(l, c, u, s) {
        throw new Ao({ reason: l, inputName: e, wanted: u, actual: s, message: c });
      };
...
function mi(o, t) {
  ...
  return new Proxy(o, { get(a, r) {
    ...
    return l == null ? null : (c) => {
      const u = Object.assign(JSON.parse(JSON.stringify(l)), { validate: () => (n(u), u), tryValidate() {
        try {
          n(u);
        } catch (s) {
      ...
      if (u !== null && typeof u == "object" && "inputs" in u) for (const s in c) {
        const d = u.inputs;
        d[s] || (d[s] = { name: s, type: "" }), d[s].value = c[s];
      }
      return u;
    };
  } });
...
class vi extends Ge {
  constructor(...t) {
    ...
    super(...t), e = this, this.run = async function(n, a) {
      try {
        ...
        if (typeof a.onError == "function") return a.onError(l);
      }
      var r;
    };
  }
  async init(t, e) {
    var n = this;
    const a = await async function r(l, c) {
      try {
        const u = await n.client.post(l, c);
  ...
  async fromString(t, e) {
    var n = this;
    const a = new ln(JSON.parse(t), async function r(l, c) {
      try {
        const u = await n.client.post(l, c);
        return new ln(u.json(), r);
      } catch (u) {
...
const xe = Ut.A && Ut.A.locals ? Ut.A.locals : void 0, Fi = () => {
  ...
  var { uiAction: t, title: e, children: n, secondary: a, dangerous: r, autofocus: l, showLastUsed: c, onClick: u, icon: s } = o, d = function(x, I) {
    var D = {};
  ...
  var t, e, n, a, r, { label: l } = o, c = function(f, C) {
    var A = {};
  ...
  const u = (0, _.useRef)(null), { isDisabled: s } = (0, _.useContext)(de), { t: d } = (0, _.useContext)(Z.TranslateContext), p = (0, _.useMemo)(() => s || c.disabled, [c, s]);
  (0, _.useEffect)(() => {
    const { current: f } = u;
...
const jo = Wt.A && Wt.A.locals ? Wt.A.locals : void 0, Ce = ({ state: o, error: t, flowError: e }) => {
  var n, a;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { uiState: l, setUIState: c } = (0, _.useContext)(de);
  return (0, _.useEffect)(() => {
    var u, s;
    if (((u = o == null ? void 0 : o.error) === null || u === void 0 ? void 0 : u.code) == "form_data_invalid_error") for (const d of Object.values(o == null ? void 0 : o.actions)) {
      ...
      let g = !1;
      for (const f of Object.values(p == null ? void 0 : p.inputs)) if (!((s = f.error) === null || s === void 0) && s.code) return c(Object.assign(Object.assign({}, l), { error: f.error })), void (g = !0);
      g || c(Object.assign(Object.assign({}, l), { error: o.error }));
    }
    else o != null && o.error && c(Object.assign(Object.assign({}, l), { error: o == null ? void 0 : o.error }));
  }, [o]), i("section", Object.assign({ part: "error", className: jo.errorBox, hidden: !(!((n = l.error) === null || n === void 0) && n.code) && !(e != null && e.code) && !t }, { children: [i("span", { children: i(bt, { name: "exclamation", size: 15 }) }), i("span", Object.assign({ id: "errorMessage", part: "error-text" }, { children: r(t ? `errors.${t.code}` : `flowErrors.${((a = l.error) === null || a === void 0 ? void 0 : a.code) || (e == null ? void 0 : e.code)}`) }))] }));
};
var Rt = X(619), ct = {};
...
const Ot = qt.A && qt.A.locals ? qt.A.locals : void 0, _n = (o) => {
  ...
  const { t: l } = (0, _.useContext)(Z.TranslateContext), { uiState: c, isDisabled: u } = (0, _.useContext)(de), [s, d] = (0, _.useState)();
  let p;
  const g = (I) => {
  ...
  }, [n]), x = (0, _.useCallback)(() => i(O.Fragment, { children: [s ? i(O.Fragment, { children: [i(_n, Object.assign({ onClick: S }, { children: l("labels.yes") })), " / ", i(_n, Object.assign({ onClick: f }, { children: l("labels.no") })), " "] }) : null, i("button", Object.assign({}, r, { onClick: e ? g : n, disabled: s || r.disabled || u, part: "link", className: Q()(Ot.link, e ? Ot.danger : null) }, { children: r.children }))] }), [s, e, n, S, r, l, u]);
  ...
  var { label: t } = o, e = function(n, a) {
    var r = {};
    for (var l in n) Object.prototype.hasOwnProperty.call(n, l) && a.indexOf(l) < 0 && (r[l] = n[l]);
    if (n != null && typeof Object.getOwnPropertySymbols == "function") {
      var c = 0;
      for (l = Object.getOwnPropertySymbols(n); c < l.length; c++) a.indexOf(l[c]) < 0 && Object.prototype.propertyIsEnumerable.call(n, l[c]) && (r[l[c]] = n[l[c]]);
    }
    return r;
  }(o, ["label"]);
...
const zi = (o) => {
  ...
  }))(k) }, { children: i(te, Object.assign({ uiAction: "passkey-submit", secondary: !0, title: be ? null : d("labels.webauthnUnsupported"), disabled: !be, icon: "passkey" }, { children: d("labels.signInPasskey") })) })) : null, !((l = (r = ae.actions).thirdparty_oauth) === null || l === void 0) && l.call(r, null) ? (c = ae.actions.thirdparty_oauth(null).inputs.provider.allowed_values) === null || c === void 0 ? void 0 : c.map((k) => i(ne, Object.assign({ onSubmit: (h) => ((b, T) => ut(void 0, void 0, void 0, function* () {
  ...
  }))(h, k.value) }, { children: i(te, Object.assign({ isLoading: k.value == me, secondary: !0, icon: k.value.startsWith("custom_") ? "customProvider" : k.value, showLastUsed: (D == null ? void 0 : D.login_method) == "third_party" && (D == null ? void 0 : D.third_party_provider) == k.value }, { children: d("labels.signInWith", { provider: k.name }) })) }), k.value)) : null, ((s = (u = ae.actions).remember_me) === null || s === void 0 ? void 0 : s.call(u, null)) && i(O.Fragment, { children: [i(en, {}), i(Nn, { required: !1, type: "checkbox", label: d("labels.staySignedIn"), checked: Oe, onChange: (k) => ut(void 0, void 0, void 0, function* () {
  ...
  const r = (0, _.useRef)(null), { isDisabled: l } = (0, _.useContext)(de), c = () => {
    const { current: s } = r;
    s && (s.focus(), s.select());
  }, u = (0, _.useMemo)(() => l || a.disabled, [a, l]);
  return (0, _.useEffect)(() => {
    t === 0 && c();
  ...
  const [a, r] = (0, _.useState)(0), l = () => o.slice(), c = () => {
    a < t - 1 && r(a + 1);
  }, u = () => {
    a > 0 && r(a - 1);
  }, s = (f) => {
    ...
    const C = f.clipboardData.getData("text/plain").slice(0, t - a).split(""), A = l();
    let S = a;
...
const Bi = (o) => {
  var t, e;
  const { t: n } = (0, _.useContext)(Z.TranslateContext), { flowState: a } = De(o.state), { hanko: r, uiState: l, setUIState: c, setLoadingAction: u, setSucceededAction: s, stateHandler: d } = (0, _.useContext)(de), [p, g] = (0, _.useState)(), [f, C] = (0, _.useState)(a.payload.resend_after), [A, S] = (0, _.useState)([]), x = (0, _.useMemo)(() => {
    var D;
  ...
  return (0, _.useEffect)(() => {
  ...
  }, [a]), i(O.Fragment, { children: [i(Se, { children: [i(ce, { children: n("headlines.loginPasscode") }), i(Ce, { state: a }), i(z, { children: l.email ? n("texts.enterPasscode", { emailAddress: l.email }) : n("texts.enterPasscodeNoEmail") }), i(ne, Object.assign({ onSubmit: (D) => At(void 0, void 0, void 0, function* () {
    ...
    u(null), yield r.flow.run(M, d);
  }), loadingSpinnerPosition: "right", isLoading: l.loadingAction === "back" }, { children: n("labels.back") })), i(ee, Object.assign({ uiAction: "passcode-resend", disabled: f > 0, onClick: (D) => At(void 0, void 0, void 0, function* () {
...
const Vi = (o) => {
  ...
  }), loadingSpinnerPosition: "right", hidden: !(!((l = (r = f.actions).back) === null || l === void 0) && l.call(r, null)) }, { children: s("labels.back") })), i(ee, Object.assign({ uiAction: "skip", onClick: (C) => cn(void 0, void 0, void 0, function* () {
...
const Zi = (o) => {
  var t, e, n, a;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { hanko: l, stateHandler: c, setLoadingAction: u } = (0, _.useContext)(de), { flowState: s } = De(o.state), [d, p] = (0, _.useState)(), [g, f] = (0, _.useState)(), C = (I) => pt(void 0, void 0, void 0, function* () {
    I.preventDefault(), u("password-recovery");
    const D = yield s.actions.continue_to_passcode_confirmation_recovery(null).run();
    u(null), yield l.flow.run(D, c);
...
const Ji = (o) => {
  const { t } = (0, _.useContext)(Z.TranslateContext), { hanko: e, stateHandler: n, setLoadingAction: a } = (0, _.useContext)(de), { flowState: r } = De(o.state), [l, c] = (0, _.useState)();
  return i(Se, { children: [i(ce, { children: t("headlines.registerPassword") }), i(Ce, { state: r }), i(z, { children: t("texts.passwordFormatHint", { minLength: r.actions.password_recovery(null).inputs.new_password.min_length, maxLength: 72 }) }), i(ne, Object.assign({ onSubmit: (u) => Gn(void 0, void 0, void 0, function* () {
    ...
    const s = yield r.actions.password_recovery({ new_password: l }).run();
...
const Qi = (o) => {
  var t, e, n, a, r, l;
  const { t: c } = (0, _.useContext)(Z.TranslateContext), { hanko: u, setLoadingAction: s, stateHandler: d, lastLogin: p } = (0, _.useContext)(de), { flowState: g } = De(o.state);
  return i(O.Fragment, { children: [i(Se, { children: [i(ce, { children: c("headlines.selectLoginMethod") }), i(Ce, { flowError: g == null ? void 0 : g.error }), i(z, { children: c("texts.howDoYouWantToLogin") }), i(ne, Object.assign({ hidden: !(!((e = (t = g.actions).continue_to_passcode_confirmation) === null || e === void 0) && e.call(t, null)), onSubmit: (f) => It(void 0, void 0, void 0, function* () {
    ...
    s(null), yield u.flow.run(C, d);
  }) }, { children: i(te, Object.assign({ secondary: !0, uiAction: "password-submit", icon: "password" }, { children: c("labels.password") })) })), i(ne, Object.assign({ hidden: !(!((l = (r = g.actions).webauthn_generate_request_options) === null || l === void 0) && l.call(r, null)), onSubmit: (f) => It(void 0, void 0, void 0, function* () {
...
const Yi = (o) => {
  ...
  }))(F, H.value) }, { children: i(te, Object.assign({ isLoading: H.value == U, secondary: !0, icon: H.value.startsWith("custom_") ? "customProvider" : H.value }, { children: u("labels.signInWith", { provider: H.name }) })) }), H.value)) : null, ((c = (l = S.actions).remember_me) === null || c === void 0 ? void 0 : c.call(l, null)) && i(O.Fragment, { children: [i(en, {}), i(Nn, { required: !1, type: "checkbox", label: u("labels.staySignedIn"), checked: ge, onChange: (H) => jt(void 0, void 0, void 0, function* () {
...
const Xi = (o) => {
  ...
  return i(O.Fragment, { children: [i(Se, { children: [i(ce, { children: s("headlines.registerPassword") }), i(Ce, { state: f }), i(z, { children: s("texts.passwordFormatHint", { minLength: f.actions.register_password(null).inputs.new_password.min_length, maxLength: 72 }) }), i(ne, Object.assign({ onSubmit: (S) => Pt(void 0, void 0, void 0, function* () {
    ...
    g(null), yield d.flow.run(x, p);
  }), loadingSpinnerPosition: "right", hidden: !(!((l = (r = f.actions).back) === null || l === void 0) && l.call(r, null)) }, { children: s("labels.back") })), i(ee, Object.assign({ uiAction: "skip", onClick: (S) => Pt(void 0, void 0, void 0, function* () {
...
const Fe = zt.A && zt.A.locals ? zt.A.locals : void 0, tn = function({ name: o, columnSelector: t, contentSelector: e, data: n, checkedItemID: a, setCheckedItemID: r, dropdown: l = !1 }) {
  const c = (0, _.useCallback)((d) => `${o}-${d}`, [o]), u = (0, _.useCallback)((d) => c(d) === a, [a, c]), s = (d) => {
    if (!(d.target instanceof HTMLInputElement)) return;
    const p = parseInt(d.target.value, 10), g = c(p);
    r(g === a ? null : g);
  };
  return i("div", Object.assign({ className: Fe.accordion }, { children: n.map((d, p) => i("div", Object.assign({ className: Fe.accordionItem }, { children: [i("input", { type: "radio", className: Fe.accordionInput, id: `${o}-${p}`, name: o, onClick: s, value: p, checked: u(p) }), i("label", Object.assign({ className: Q()(Fe.label, l && Fe.dropdown), for: `${o}-${p}` }, { children: i("span", Object.assign({ className: Fe.labelText }, { children: t(d, p) })) })), i("div", Object.assign({ className: Q()(Fe.accordionContent, l && Fe.dropdownContent) }, { children: e(d, p) }))] }), p)) }));
}, Ne = ({ children: o }) => i("h2", Object.assign({ part: "headline2", className: Q()(Vt.headline, Vt.grade2) }, { children: o })), Gi = ({ onEmailDelete: o, onEmailSetPrimary: t, onEmailVerify: e, checkedItemID: n, setCheckedItemID: a, emails: r = [], deletableEmailIDs: l = [] }) => {
  const { t: c } = (0, _.useContext)(Z.TranslateContext), u = (0, _.useMemo)(() => !1, []);
  return i(tn, { name: "email-edit-dropdown", columnSelector: (s) => {
    const d = i("span", Object.assign({ className: Fe.description }, { children: s.is_verified ? s.is_primary ? i(O.Fragment, { children: [" -", " ", c("labels.primaryEmail")] }) : null : i(O.Fragment, { children: [" -", " ", c("labels.unverifiedEmail")] }) }));
...
}, eo = ({ credentials: o = [], checkedItemID: t, setCheckedItemID: e, onBack: n, onCredentialNameSubmit: a, onCredentialDelete: r, allowCredentialDeletion: l, credentialType: c }) => {
  ...
  return i(tn, { name: c === "security-key" ? "security-key-edit-dropdown" : "passkey-edit-dropdown", columnSelector: (g) => d(g), data: o, contentSelector: (g) => i(O.Fragment, { children: [i(z, { children: [i(Ne, { children: u(c === "security-key" ? "headlines.renameSecurityKey" : "headlines.renamePasskey") }), u(c === "security-key" ? "texts.renameSecurityKey" : "texts.renamePasskey"), i("br", {}), i(ee, Object.assign({ onClick: (f) => ((C, A, S) => {
    C.preventDefault(), s(i(ea, { oldName: d(A), credential: A, credentialType: S, onBack: n, onCredentialNameSubmit: a }));
  })(f, g, c), loadingSpinnerPosition: "right" }, { children: u("labels.rename") }))] }), i(z, Object.assign({ hidden: !l }, { children: [i(Ne, { children: u(c === "security-key" ? "headlines.deleteSecurityKey" : "headlines.deletePasskey") }), u(c === "security-key" ? "texts.deleteSecurityKey" : "texts.deletePasskey"), i("br", {}), i(ee, Object.assign({ uiAction: "password-delete", dangerous: !0, onClick: (f) => r(f, g.id), loadingSpinnerPosition: "right" }, { children: u("labels.delete") }))] })), i(z, { children: [i(Ne, { children: u("headlines.lastUsedAt") }), g.last_used_at ? p(g.last_used_at) : "-"] }), i(z, { children: [i(Ne, { children: u("headlines.createdAt") }), p(g.created_at)] })] }), checkedItemID: t, setCheckedItemID: e });
...
}, oo = ({ inputs: o, checkedItemID: t, setCheckedItemID: e, onUsernameSubmit: n, onUsernameDelete: a, hasUsername: r, allowUsernameDeletion: l }) => {
  var c;
  ...
  }, value: s, flowInput: o.username }), i(te, Object.assign({ uiAction: "username-set" }, { children: u("labels.save") }))] })), i(ee, Object.assign({ hidden: !l, uiAction: "username-delete", dangerous: !0, onClick: (p) => a(p).then(() => d("")), loadingSpinnerPosition: "right" }, { children: u("labels.delete") }))] }));
  ...
  const { t: r } = (0, _.useContext)(Z.TranslateContext), l = (c) => new Date(c).toLocaleString();
  ...
  }, data: o, contentSelector: (c) => i(O.Fragment, { children: [i(z, Object.assign({ hidden: !c.ip_address }, { children: [i(Ne, { children: r("headlines.ipAddress") }), c.ip_address] })), i(z, { children: [i(Ne, { children: r("headlines.lastUsed") }), l(c.last_used)] }), i(z, { children: [i(Ne, { children: r("headlines.createdAt") }), l(c.created_at)] }), a != null && a.includes(c.id) ? i(z, { children: [i(Ne, { children: r("headlines.revokeSession") }), i(ee, Object.assign({ uiAction: "session-delete", dangerous: !0, onClick: (u) => n(u, c.id), loadingSpinnerPosition: "right" }, { children: r("labels.revoke") }))] }) : null] }), checkedItemID: t, setCheckedItemID: e });
}, ia = ({ checkedItemID: o, setCheckedItemID: t, onDelete: e, onConnect: n, authAppSetUp: a, allowDeletion: r }) => {
  const { t: l } = (0, _.useContext)(Z.TranslateContext), c = i("span", Object.assign({ className: Fe.description }, { children: a ? i(O.Fragment, { children: [" -", " ", l("labels.configured")] }) : null })), u = i(O.Fragment, { children: [l("labels.authenticatorAppManage"), " ", c] });
  return i(kt, Object.assign({ name: "authenticator-app-manage-dropdown", title: u, checkedItemID: o, setCheckedItemID: t }, { children: [i(Ne, { children: l(a ? "headlines.authenticatorAppAlreadySetUp" : "headlines.authenticatorAppNotSetUp") }), i(z, { children: [l(a ? "texts.authenticatorAppAlreadySetUp" : "texts.authenticatorAppNotSetUp"), i("br", {}), i(ee, a ? Object.assign({ hidden: !r, uiAction: "auth-app-remove", onClick: (s) => e(s), loadingSpinnerPosition: "right", dangerous: !0 }, { children: l("labels.delete") }) : Object.assign({ uiAction: "auth-app-add", onClick: (s) => n(s), loadingSpinnerPosition: "right" }, { children: l("labels.authenticatorAppAdd") }))] })] }));
};
...
const Po = (o) => {
  var t, e, n, a, r, l, c, u, s, d, p, g, f, C, A, S, x, I, D, M, U, ie, ge, ae, be, H, F, me, Pe, Oe, Ee, re, se, ue, Ae, k, h, b, T, K, he, Me, Ue, He, m, v, y, E, N, P, q, G;
  ...
  }), [r]), i(Se, { children: [i(ce, { children: e("headlines.error") }), i(Ce, { state: o, error: t }), i(ne, Object.assign({ onSubmit: (l) => {
    l.preventDefault(), r();
...
const ra = (o) => {
  var t, e, n, a;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { hanko: l, stateHandler: c, setLoadingAction: u } = (0, _.useContext)(de), { flowState: s } = De(o.state), [d, p] = (0, _.useState)();
  ...
  }), placeholder: r("labels.email"), pattern: "^.*[^0-9]+$", value: d }), i(te, Object.assign({ uiAction: "email-submit" }, { children: r("labels.continue") }))] }))] }), i(Le, Object.assign({ hidden: !(!((a = (n = s.actions).skip) === null || a === void 0) && a.call(n, null)) }, { children: [i("span", { hidden: !0 }), i(ee, Object.assign({ uiAction: "skip", onClick: (g) => dn(void 0, void 0, void 0, function* () {
...
const sa = (o) => {
  ...
  return i(O.Fragment, { children: [i(Se, { children: [i(ce, { children: r("headlines.createUsername") }), i(Ce, { state: s }), i(ne, Object.assign({ onSubmit: (g) => un(void 0, void 0, void 0, function* () {
    ...
    g.target instanceof HTMLInputElement && p(g.target.value);
  }), value: d, placeholder: r("labels.username") }), i(te, Object.assign({ uiAction: "username-set" }, { children: r("labels.continue") }))] }))] }), i(Le, Object.assign({ hidden: !(!((a = (n = s.actions).skip) === null || a === void 0) && a.call(n, null)) }, { children: [i("span", { hidden: !0 }), i(ee, Object.assign({ uiAction: "skip", onClick: (g) => un(void 0, void 0, void 0, function* () {
    g.preventDefault(), u("skip");
    const f = yield s.actions.skip(null).run();
    u(null), yield l.flow.run(f, c);
  }), loadingSpinnerPosition: "left" }, { children: r("labels.skip") }))] }))] });
...
const ca = (o) => {
  var t, e, n, a;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { flowState: l } = De(o.state), { hanko: c, setLoadingAction: u, stateHandler: s } = (0, _.useContext)(de), [d, p] = (0, _.useState)([]), g = (0, _.useCallback)((f) => hn(void 0, void 0, void 0, function* () {
    u("passcode-submit");
    const C = yield l.actions.otp_code_validate({ otp_code: f }).run();
    u(null), yield c.flow.run(C, s);
  }), [c, l, u, s]);
  return (0, _.useEffect)(() => {
    var f;
    ((f = l.error) === null || f === void 0 ? void 0 : f.code) === "passcode_invalid" && p([]);
  }, [l]), i(O.Fragment, { children: [i(Se, { children: [i(ce, { children: r("headlines.otpLogin") }), i(Ce, { state: l }), i(z, { children: r("texts.otpLogin") }), i(ne, Object.assign({ onSubmit: (f) => hn(void 0, void 0, void 0, function* () {
    return f.preventDefault(), g(d.join(""));
  }) }, { children: [i(Mn, { onInput: (f) => {
    if (p(f), f.filter((C) => C !== "").length === 6) return g(f.join(""));
  }, passcodeDigits: d, numberOfInputs: 6 }), i(te, Object.assign({ uiAction: "passcode-submit" }, { children: r("labels.continue") }))] }))] }), i(Le, Object.assign({ hidden: !(!((e = (t = l.actions).continue_to_login_security_key) === null || e === void 0) && e.call(t, null)) }, { children: i(ee, Object.assign({ uiAction: "skip", onClick: (f) => hn(void 0, void 0, void 0, function* () {
    f.preventDefault(), u("skip");
    const C = yield l.actions.continue_to_login_security_key(null).run();
    u(null), yield c.flow.run(C, s);
  }), loadingSpinnerPosition: "right", hidden: !(!((a = (n = l.actions).continue_to_login_security_key) === null || a === void 0) && a.call(n, null)) }, { children: r("labels.useAnotherMethod") })) }))] });
};
...
const da = (o) => {
  var t, e, n, a;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { hanko: l, setLoadingAction: c, stateHandler: u } = (0, _.useContext)(de), { flowState: s } = De(o.state);
...
const ua = (o) => {
  ...
  return i(O.Fragment, { children: [i(Se, { children: [i(ce, { children: s("headlines.mfaSetUp") }), i(Ce, { flowError: f == null ? void 0 : f.error }), i(z, { children: s("texts.mfaSetUp") }), S ? i(ne, Object.assign({ onSubmit: S }, { children: i(te, Object.assign({ uiAction: "passcode-submit" }, { children: s("labels.continue") })) })) : i(O.Fragment, { children: [i(ne, Object.assign({ hidden: !(!((e = (t = f.actions).continue_to_security_key_creation) === null || e === void 0) && e.call(t, null)), onSubmit: C }, { children: i(te, Object.assign({ secondary: !0, uiAction: "passcode-submit", icon: "securityKey" }, { children: s("labels.securityKey") })) })), i(ne, Object.assign({ hidden: !(!((a = (n = f.actions).continue_to_otp_secret_creation) === null || a === void 0) && a.call(n, null)), onSubmit: A }, { children: i(te, Object.assign({ secondary: !0, uiAction: "password-submit", icon: "qrCodeScanner" }, { children: s("labels.authenticatorApp") })) }))] })] }), i(Le, { children: [i(ee, Object.assign({ uiAction: "back", onClick: (x) => Dt(void 0, void 0, void 0, function* () {
    ...
    p(null), yield d.flow.run(I, g);
  }), loadingSpinnerPosition: "right", hidden: !(!((l = (r = f.actions).back) === null || l === void 0) && l.call(r, null)) }, { children: s("labels.back") })), i(ee, Object.assign({ uiAction: "skip", onClick: (x) => Dt(void 0, void 0, void 0, function* () {
...
const ha = $t.A && $t.A.locals ? $t.A.locals : void 0, pa = ({ children: o, text: t }) => {
  ...
  return i("section", Object.assign({ className: _t.clipboardContainer }, { children: [i("div", { children: [o, " "] }), i("div", Object.assign({ className: _t.clipboardIcon, onClick: (r) => {
    return l = void 0, c = void 0, s = function* () {
      r.preventDefault();
      try {
...
const ma = (o) => {
  const { t } = (0, _.useContext)(Z.TranslateContext), { flowState: e } = De(o.state), { hanko: n, uiState: a, setLoadingAction: r, stateHandler: l } = (0, _.useContext)(de), [c, u] = (0, _.useState)([]), s = (0, _.useCallback)((d) => pn(void 0, void 0, void 0, function* () {
    r("passcode-submit");
    const p = yield e.actions.otp_code_verify({ otp_code: d }).run();
    r(null), yield n.flow.run(p, l);
  }), [e, r, l]);
  return (0, _.useEffect)(() => {
    var d;
    ((d = e.error) === null || d === void 0 ? void 0 : d.code) === "passcode_invalid" && u([]);
  }, [e]), i(O.Fragment, { children: [i(Se, { children: [i(ce, { children: t("headlines.otpSetUp") }), i(Ce, { state: e }), i(z, { children: t("texts.otpScanQRCode") }), i(fa, { src: e.payload.otp_image_source, secret: e.payload.otp_secret }), i(z, { children: t("texts.otpEnterVerificationCode") }), i(ne, Object.assign({ onSubmit: (d) => pn(void 0, void 0, void 0, function* () {
    return d.preventDefault(), s(c.join(""));
  }) }, { children: [i(Mn, { onInput: (d) => {
    if (u(d), d.filter((p) => p !== "").length === 6) return s(d.join(""));
  }, passcodeDigits: c, numberOfInputs: 6 }), i(te, Object.assign({ uiAction: "passcode-submit" }, { children: t("labels.continue") }))] }))] }), i(Le, { children: i(ee, Object.assign({ onClick: (d) => pn(void 0, void 0, void 0, function* () {
...
const ga = (o) => {
  var t, e, n, a;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { hanko: l, setLoadingAction: c, stateHandler: u } = (0, _.useContext)(de), { flowState: s } = De(o.state);
  return i(O.Fragment, { children: [i(Se, { children: [i(ce, { children: r("headlines.trustDevice") }), i(Ce, { flowError: s == null ? void 0 : s.error }), i(z, { children: r("texts.trustDevice") }), i(ne, Object.assign({ onSubmit: (d) => fn(void 0, void 0, void 0, function* () {
    d.preventDefault(), c("trust-device-submit");
    const p = yield s.actions.trust_device(null).run();
    c(null), yield l.flow.run(p, u);
  }) }, { children: i(te, Object.assign({ uiAction: "trust-device-submit" }, { children: r("labels.trustDevice") })) }))] }), i(Le, { children: [i(ee, Object.assign({ uiAction: "back", onClick: (d) => fn(void 0, void 0, void 0, function* () {
    d.preventDefault(), c("back");
    const p = yield s.actions.back(null).run();
    c(null), yield l.flow.run(p, u);
  }), loadingSpinnerPosition: "right", hidden: !(!((e = (t = s.actions).back) === null || e === void 0) && e.call(t, null)) }, { children: r("labels.back") })), i(ee, Object.assign({ uiAction: "skip", onClick: (d) => fn(void 0, void 0, void 0, function* () {
    d.preventDefault(), c("skip");
...
const Lt = "flow-state", de = (0, O.createContext)(null), _a = (o) => {
  var { lang: t, experimental: e = "", prefilledEmail: n, prefilledUsername: a, globalOptions: r, createWebauthnAbortSignal: l } = o, c = function(h, b) {
    var T = {};
  ...
  const C = (0, _.useRef)(null), A = (0, _.useMemo)(() => `${r.storageKey}_last_login`, [r.storageKey]), [S, x] = (0, _.useState)(c.componentName), I = (0, _.useMemo)(() => e.split(" ").filter((h) => h.length).map((h) => h), [e]), D = (0, _.useMemo)(() => i(qi, {}), []), [M, U] = (0, _.useState)(D), [, ie] = (0, _.useState)(u), [ge, ae] = (0, _.useState)(), [be, H] = (0, _.useState)({ email: n, username: a }), F = (0, _.useCallback)((h) => {
      ...
      U(i(zi, { state: h })), function() {
        We(this, void 0, void 0, function* () {
          if (h.payload.request_options) {
            let b;
            try {
              b = yield Yn({ publicKey: h.payload.request_options.publicKey, mediation: "conditional", signal: l() });
            } catch {
              return;
            }
            F("passkey-submit");
    ...
    return We(this, void 0, void 0, function* () {
      ...
      F("passkey-submit");
      try {
        b = yield Yn(Object.assign(Object.assign({}, h.payload.request_options), { signal: l() }));
      } catch {
    ...
    return We(this, void 0, void 0, function* () {
      let b;
      try {
        b = yield Qn(Object.assign(Object.assign({}, h.payload.creation_options), { signal: l() }));
      } catch {
        const he = yield h.actions.back(null).run();
  ...
  return i(de.Provider, Object.assign({ value: { init: Ae, initialComponentName: c.componentName, isDisabled: Oe, setUIState: H, setLoadingAction: F, setSucceededAction: me, uiState: be, hanko: u, setHanko: ie, lang: (t == null ? void 0 : t.toString()) || f, prefilledEmail: n, prefilledUsername: a, componentName: S, setComponentName: x, experimentalFeatures: I, hidePasskeyButtonOnLogin: d, page: M, setPage: U, stateHandler: se, lastLogin: ge } }, { children: i(Z.TranslateProvider, Object.assign({ translations: p, fallbackLang: f, root: g }, { children: i(wi, Object.assign({ ref: C }, { children: S !== "events" ? i(O.Fragment, { children: [s ? i("style", { dangerouslySetInnerHTML: { __html: window._hankoStyle.innerHTML } }) : null, M] }) : null })) })) }));
}, ba = { en: X(6).en };
...
const Ca = () => (Tt && Tt.abort(), Tt = new AbortController(), Tt.signal), vt = ({ tagName: o, entryComponent: t, shadow: e = !0, observedAttributes: n }) => Eo(void 0, void 0, void 0, function* () {
  customElements.get(o) || function(a, r, l, c) {
    function u() {
      var s = Reflect.construct(HTMLElement, [], u);
      return s._vdomComponent = a, s._root = c && c.shadow ? s.attachShadow({ mode: "open" }) : s, s;
    }
    (u.prototype = Object.create(HTMLElement.prototype)).constructor = u, u.prototype.connectedCallback = Ho, u.prototype.attributeChangedCallback = Wo, u.prototype.disconnectedCallback = Ro, l = l || a.observedAttributes || Object.keys(a.propTypes || {}), u.observedAttributes = l, l.forEach(function(s) {
...
class Ia extends HTMLElement {
  ...
  async syncJWTToCookie() {
    try {
      const t = this._sessionJWT;
      if (t) {
        const e = window.location.hostname, n = e === "localhost" || e === "127.0.0.1", a = n ? "; domain=localhost" : "";
        document.cookie = `hanko=${t}; path=/${a}; max-age=86400; SameSite=Lax`, this.log(`🔐 JWT synced to cookie for SSO${n ? " (domain=localhost)" : ""}`);
      } else
  ...
  async checkOSMConnection() {
    try {
      ...
      if (this.log("📡 OSM status response:", l.status), this.log("📡 Final URL after redirects:", l.url), l.ok) {
        const c = await l.json();
        this.log("📡 OSM status data:", c), c.connected ? (this.log("✅ OSM is connected:", c.osm_username), this.state.osmConnected = !0, this.state.osmData = c) : this.log("❌ OSM is NOT connected");
      }
    } catch (t) {
  ...
  setupEventListeners() {
    ...
    t && (t.addEventListener("onSessionCreated", (r) => {
      ...
      const l = (u = (c = r.detail) == null ? void 0 : c.claims) == null ? void 0 : u.session_id;
      if (l && this._lastSessionId === l) {
        this.log("⏭️ Skipping duplicate session event");
        return;
      }
      this._lastSessionId = l, this.handleHankoSuccess(r);
  ...
  async handleHankoSuccess(t) {
    ...
    if (this._sessionJWT = ((r = t.detail) == null ? void 0 : r.jwt) || null, !n) {
      console.error("No user ID found in claims");
      return;
    }
    try {
      const { Hanko: l } = await Promise.resolve().then(() => mn), u = await new l(this.hankoUrl).user.getCurrent();
      this.log("👤 User data from Hanko:", u), this.state.user = {
        id: u.id || n,
        email: u.email,
        username: u.username,
      ...
      console.error("Failed to fetch user info:", l), this.state.user = {
        id: n,
        email: null,
        username: null,
        emailVerified: !1
  ...
  async handleOSMConnect() {
    ...
    const l = `${a}${r}?scopes=${t}`;
    this.log("🔗 OSM Connect clicked!"), this.log("  window.location.origin:", a), this.log("  basePath:", e), this.log("  authPath:", n), this.log("  loginPath:", r), this.log("  Full URL to redirect to:", l), this.log("  About to set window.location.href..."), window.location.href = l, this.log("  window.location.href was set (this may not log if redirect is immediate)");
  }
  async handleLogout() {
    if (this.log("🚪 Logout initiated"), this.log("📊 Current state before logout:", {
      ...
      try {
        ...
        this.log("📡 Disconnect response status:", l.status), this.log("📡 Disconnect response headers:", [...l.headers.entries()]);
        const c = await l.json();
  ...
  render() {
    ...
    if (this.state.loading)
      ...
      const a = this.osmEnabled && !this.state.osmConnected, r = this.state.user.username || this.state.user.email || this.state.user.id, l = r ? r[0].toUpperCase() : "U";
      e = `
        <div class="container">
          ${this.showProfile ? `
            <div class="profile">
